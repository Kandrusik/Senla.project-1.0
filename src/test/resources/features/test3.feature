...
@test @CancelOfBuyingThings
Функционал: Проверка отмены покупки товаров на сайте Saucedemo

  Сценарий: Проверка, что два товара добавлены в корзину, дошли до оформления покупки и отменили наш заказ
    ...
    И нажатие на кнопку отмены покупки "Checkout: Cancel!"
    Тогда загрузилась страница, с названием шапки PRODUCTS "PRODUCTS"